...
root.configure(background="lightyellow3")

label1 = Label(root, text="Enter the Code", font="timesnewroman 15 bold",background="lightyellow3",foreground="black", padx=20, pady=20)
label1.grid(row=0, column=1,padx=(80,0))
label2 = Label(root, text="Lexical Analysis", font="timesnewroman 15 bold",background="lightyellow3",foreground="black", padx=20, pady=20)
...
def symbol():
    ...
    root2.configure(background="cadetblue2")

    label = Label(root2, text="Symbol Table", font="timesnewroman 15 bold", background="cadetblue2", foreground="black", padx=20,pady=20)
...
btn1 = Button(root, text="Analyze", font="times 15 bold", bg="white", command=show)
btn1.grid(row=2, column=1, ipadx=30, pady=40, padx=(50,0))
btn2 = Button(root, text="Clear", font="times 15 bold", bg="white", command=clear)
btn2.grid(row=2, columnspan=3, column=2, ipadx=40, pady=40, padx=(20,0))
btn3 = Button(root, text="Symbol Table", font="times 15 bold", bg="white", command=symbol)
